...
public class ElectricMeter extends AbstractCyPhyComponent implements ElectricMeterImplementationI {
	...
	protected AtomicReference<SensorData<Measure<Double>>> currentPowerConsumption;
	protected AtomicReference<SensorData<Measure<Double>>> currentPowerProduction;
	...
	protected ElectricMeter(String electricMeterInboundPortURI, ExecutionType currentExecutionType) throws Exception {
		this(REFLECTION_INBOUND_PORT_URI, electricMeterInboundPortURI,
	...
	protected void initialise(String electricMeterInboundPortURI) throws Exception {
		assert	electricMeterInboundPortURI != null &&
										!electricMeterInboundPortURI.isEmpty() :
				new PreconditionException(
						"electricMeterInboundPortURI != null && "
		...
		this.inboundPort = new ElectricMeterInboundPort(electricMeterInboundPortURI, this);
