...
public class SmartLightingUserInboundPort extends AbstractInboundPort
    implements SmartLightingUserCI {
  ...
  public double getTargetIllumination() throws Exception {
    return this.getOwner()
        .handleRequest(owner -> ((SmartLightingUserI) owner).getTargetIllumination());
  }

  @Override
  public double getCurrentIllumination() throws Exception {
    return this.getOwner()
        .handleRequest(owner -> ((SmartLightingUserI) owner).getCurrentIllumination());
  }
  ...
  public double getCurrentPowerLevel() throws Exception {
    return this.getOwner()
        .handleRequest(owner -> ((SmartLightingUserI) owner).getCurrentPowerLevel());
  }
