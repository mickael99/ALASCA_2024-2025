...
public class SmartLightingInternalControlInboundPort extends AbstractInboundPort
  ...
  public boolean isSwitchingAutomatically() throws Exception {
    return this.getOwner()
        .handleRequest(owner -> ((SmartLightingInternalControlI) owner).isSwitchingAutomatically());
  }
  ...
  public double getTargetIllumination() throws Exception {
    return this.getOwner()
        .handleRequest(owner -> ((SmartLightingInternalControlI) owner).getTargetIllumination());
  }
  ...
  public double getCurrentIllumination() throws Exception {
    return this.getOwner()
        .handleRequest(owner -> ((SmartLightingInternalControlI) owner).getCurrentIllumination());
  }
