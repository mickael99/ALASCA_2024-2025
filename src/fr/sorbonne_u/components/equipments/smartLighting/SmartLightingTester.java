...
//        this(isUnitTest,
//             fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.USER_INBOUND_PORT_URI,
//             fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.INTERNAL_CONTROL_INBOUND_PORT_URI,
//             fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.EXTERNAL_CONTROL_INBOUND_PORT_URI
//            );
//    }
//
...
//            this.slop.setTargetIllumination(fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.STANDARD_TARGET_ILLUMINATION);
//            this.slop.switchOff();
//        } catch (Exception e) {
//            this.traceMessage("...KO. " + e + "\n");
//            fail();
...
//        try {
//            assertEquals(fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.MAX_POWER_LEVEL, this.slop.getMaxPowerLevel());
//            this.slop.switchOn();
//            this.slop.setCurrentPowerLevel(fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.MAX_POWER_LEVEL / 2.0);
//            assertEquals(fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.MAX_POWER_LEVEL / 2.0, this.slop.getCurrentPowerLevel());
//            this.slop.switchOff();
//        } catch (Exception e) {
//            this.traceMessage("...KO. " + e + "\n");
//            fail();
...
//        try {
//            this.slop.switchOn();
//            assertEquals(fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.STANDARD_TARGET_ILLUMINATION, this.slop.getTargetIllumination());
//            assertTrue(this.slop.isOn());
//            assertEquals(0, this.slop.getCurrentIllumination());
...
//            this.slop.switchOn();
//            this.slecop.setCurrentPowerLevel(fr.sorbonne_u.components.equipments.smartLighting.SmartLighting.MAX_POWER_LEVEL / 2.0);
