...
public class SmartLightingIlluminanceModel extends AtomicHIOA implements SmartLightingOperationI {
  ...
  public static final String MIL_RT_URI =
      SmartLightingIlluminanceModel.class.getSimpleName() + "-MIL-RT";
  ...
  protected SmartLightingStateModel.State currentState = SmartLightingStateModel.State.ON;
  ...
  // Invariants
  // ------------------------------------------------------------------------
  protected static boolean glassBoxInvariants(SmartLightingIlluminanceModel instance) {
    assert instance != null
        : new NeoSim4JavaException(
            "SmartLightingIlluminanceModel: Precondition violation: instance != null");
    ...
    ret &=
        InvariantChecking.checkGlassBoxInvariant(
            STEP > 0.0, SmartLightingIlluminanceModel.class, instance, "STEP > 0.0");
    ret &=
        InvariantChecking.checkGlassBoxInvariant(
  ...
  protected static boolean blackBoxInvariants(SmartLightingIlluminanceModel instance) {
  ...
  public SmartLightingIlluminanceModel(
    ...
    assert glassBoxInvariants(this)
        : new NeoSim4JavaException(
            "SmartLightingIlluminanceModel: White-box invariants violation!");
    assert blackBoxInvariants(this)
        : new NeoSim4JavaException(
            "SmartLightingIlluminanceModel: Black-Box invariants violation!");
  }
  ...
  public void setState(SmartLightingStateModel.State s) {
    this.currentState = s;
  ...
  public void setCurrentPower(double power, Time t) {
    this.currentPowerLevel.setNewValue(power, t);
  ...
  public void setCurrentIlluminance(double i) {
    this.currentIlluminance.setNewValue(
        i, new Time(this.getCurrentStateTime().getSimulatedTime(), this.getSimulatedTimeUnit()));
  ...
  public Pair<Integer, Integer> fixpointInitialiseVariables() {
    ...
    if (!this.currentIlluminance.isInitialised() && this.externalIlluminance.isInitialised()) {
      this.currentIlluminance.initialise(INITIAL_ILLUMINANCE * ILLUMINANCE_TRANSITION_PARAM);
      justInitialised++;
  ...
  public void userDefinedInternalTransition(Duration elapsedTime) {
    double newTemp = this.computeNewIlluminance(elapsedTime.getSimulatedDuration());
    this.currentIlluminance.setNewValue(
        newTemp,
    ...
    if (this.currentState == SmartLightingStateModel.State.ON) {
      mark = "(o)";
    } else if (this.currentState == SmartLightingStateModel.State.DECREASE) {
      mark = "(-)";
    } else {
      mark = "(+)";
    }
  ...
  public void endSimulation(Time endTime) {
    this.meanIlluminance =
        this.illuminanceAcc / endTime.subtract(this.start).getSimulatedDuration();
  ...
  public static class SmartLightingIlluminanceReport implements SimulationReportI, HEM_ReportI {
    private static final long serialVersionUID = 1L;
    protected String modelURI;
    protected double meanIlluminance;

    public SmartLightingIlluminanceReport(String modelURI, double meanIlluminance) {
      super();
  ...
  public SimulationReportI getFinalReport() {
    return new SmartLightingIlluminanceReport(this.getURI(), this.meanIlluminance);
  }
}
// -----------------------------------------------------------------------------
