...
public class SmartLightingUnitTesterModel extends AtomicModel {
  ...
  public ArrayList<EventI> output() {
    ...
    if (this.step > 0 && this.step < 10) {
      switch (this.step) {
        case 1:
          currentEvent = new TurnOnSmartLighting(this.getTimeOfNextEvent());
          break;
        case 2:
          currentEvent = new IncreaseLighting(this.getTimeOfNextEvent());
          break;
        case 3:
          currentEvent = new DecreaseLighting(this.getTimeOfNextEvent());
          break;
        case 4:
          currentEvent = new StopAdjustingLighting(this.getTimeOfNextEvent());
          break;
        case 5:
            currentEvent =
                new SetPowerSmartLighting(
                    this.getTimeOfNextEvent(), new SetPowerSmartLighting.PowerValue(500));
          break;
        case 6:
            currentEvent =
                new SetPowerSmartLighting(
                    this.getTimeOfNextEvent(), new SetPowerSmartLighting.PowerValue(300));
          break;
        case 7:
            currentEvent =
                new SetPowerSmartLighting(
                    this.getTimeOfNextEvent(), new SetPowerSmartLighting.PowerValue(100));
          break;
        case 8:
            currentEvent =
                new SetPowerSmartLighting(
                    this.getTimeOfNextEvent(), new SetPowerSmartLighting.PowerValue(0));
          break;
        case 9:
            currentEvent =
                new TurnOffSmartLighting(this.getTimeOfNextEvent());
          break;
        default:
          currentEvent = null;
      }
      ArrayList<EventI> ret = new ArrayList<EventI>();
        ...
        this.logMessage("emmited event: " + currentEvent + ".");
        return ret;
    } else {
      return null;
    }
