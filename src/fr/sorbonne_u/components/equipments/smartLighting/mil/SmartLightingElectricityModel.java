...
// -------------------------------------------------------------------------
public class SmartLightingElectricityModel extends AtomicHIOA implements SmartLightingOperationI {
  ...
  public static final String MIL_URI = SmartLightingElectricityModel.class.getSimpleName() + "-MIL";
  public static final String MIL_RT_URI =
      SmartLightingElectricityModel.class.getSimpleName() + "-MIL-RT";
  public static final String SIL_URI = SmartLightingElectricityModel.class.getSimpleName() + "-SIL";
  ...
  protected static double INITIAL_LIGHTING_POWER = MAX_LIGHTING_POWER;

  protected SmartLightingStateModel.State currentState = SmartLightingStateModel.State.OFF;
  ...
  protected final Value<Double> currentPowerLevel = new Value<Double>(this);
  ...
  protected static boolean glassBoxInvariants(SmartLightingElectricityModel instance) {
    assert instance != null
        : new NeoSim4JavaException(
            "SmartLightingElectricityModel: Precondition violation: instance != null");
    ...
    ret &=
        InvariantChecking.checkGlassBoxInvariant(
            TENSION >= 0.0, SmartLightingElectricityModel.class, instance, "TENSION >= 0.0");
    ret &=
        InvariantChecking.checkGlassBoxInvariant(
  ...
  protected static boolean blackBoxInvariants(SmartLightingElectricityModel instance) {
    ...
    ret &=
        InvariantChecking.checkBlackBoxInvariant(
            NOT_LIGHTING_POWER_RUNPNAME != null && !NOT_LIGHTING_POWER_RUNPNAME.isEmpty(),
            SmartLightingElectricityModel.class,
            instance,
            "NOT_LIGHTING_POWER_RUNPNAME != null &&" + " !NOT_LIGHTING_POWER_RUNPNAME.isEmpty()");
    ret &=
        InvariantChecking.checkBlackBoxInvariant(
            MAX_LIGHTING_POWER_RUNPNAME != null && !MAX_LIGHTING_POWER_RUNPNAME.isEmpty(),
            SmartLightingElectricityModel.class,
            instance,
            "MAX_LIGHTING_POWER_RUNPNAME != null &&" + " !MAX_LIGHTING_POWER_RUNPNAME.isEmpty()");
    ret &=
  ...
  public SmartLightingElectricityModel(
    ...
    assert glassBoxInvariants(this)
        : new NeoSim4JavaException(
            "SmartLightingElectricityModel: White box invariants violation!");
    assert blackBoxInvariants(this)
        : new NeoSim4JavaException(
            "SmartLightingElectricityModel: Black box invariants violation!");
  }
  ...
  public void setState(SmartLightingStateModel.State state) {
    SmartLightingStateModel.State old = this.currentState;
  ...
  public void setCurrentLightingPower(double newPower, Time time) {
    assert newPower >= 0.0 && newPower <= MAX_LIGHTING_POWER
        : new NeoSim4JavaException(
            "SmartLightingElectricityModel: Precondition violation: newPower >= 0.0 &&"
  ...
  public void initialiseState(Time initialTime) {
    ...
    this.currentState = SmartLightingStateModel.State.OFF;
  ...
  public Pair<Integer, Integer> fixpointInitialiseVariables() {
    ...
    if (!this.currentIntensity.isInitialised() || !this.currentPowerLevel.isInitialised()) {
  ...
  public void userDefinedInternalTransition(Duration elapsedTime) {
    ...
    if (this.currentState == SmartLightingStateModel.State.ON) {
      this.currentIntensity.setNewValue(
          SmartLightingElectricityModel.NOT_LIGHTING_POWER / SmartLightingElectricityModel.TENSION,
          t);
    } else if (this.currentState == SmartLightingStateModel.State.INCREASE || this.currentState == SmartLightingStateModel.State.DECREASE) {
      this.currentIntensity.setNewValue(
          this.currentPowerLevel.getValue() / SmartLightingElectricityModel.TENSION, t);
    } else {
      assert this.currentState == SmartLightingStateModel.State.OFF;
  ...
  /**
   * @see ModelI#setSimulationRunParameters(Map)
   */
  @Override
  public void setSimulationRunParameters(Map<String, Object> simParams)
    ...
    String notHeatingName = ModelI.createRunParameterName(getURI(), NOT_LIGHTING_POWER_RUNPNAME);
    if (simParams.containsKey(notHeatingName)) {
      NOT_LIGHTING_POWER = (double) simParams.get(notHeatingName);
    }
    String heatingName = ModelI.createRunParameterName(getURI(), MAX_LIGHTING_POWER_RUNPNAME);
  ...
  // -------------------------------------------------------------------------
  public static class SmartLightingElectricityReport implements SimulationReportI, HEM_ReportI {
    private static final long serialVersionUID = 1L;
    protected String modelURI;
    protected double totalConsumption;

    public SmartLightingElectricityReport(String modelURI, double totalConsumption) {
      super();
  ...
  /**
   * @see ModelI#getFinalReport()
   */
  @Override
  public SimulationReportI getFinalReport() {
    return new SmartLightingElectricityReport(this.getURI(), this.totalConsumption);
  }
}
// -----------------------------------------------------------------------------
