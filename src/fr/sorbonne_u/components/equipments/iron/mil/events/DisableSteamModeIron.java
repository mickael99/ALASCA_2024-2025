...
public class DisableSteamModeIron extends AbstractIronEvent {

	private static final long serialVersionUID = 1L;

	public DisableSteamModeIron(Time timeOfOccurrence) {
	...
	public boolean hasPriorityOver(EventI e)
	{
		if(e instanceof TurnOnIron || e instanceof EnableDelicateModeIron
				...
				|| e instanceof EnableSteamModeIron) 
		{
			return false;
		}
	...
	public void	executeOn(AtomicModelI model)
	{
		...
		((IronOperationI)model).disableSteamMode();
	}
}
