...
public class EnableEnergySavingModeIron extends AbstractIronEvent {

	private static final long serialVersionUID = 1L;

	public EnableEnergySavingModeIron(Time timeOfOccurrence) {
	...
	public void	executeOn(AtomicModelI model)
	{
		...
		((IronOperationI)model).enableEnergySavingMode();
	}
}
