...
public class SmartLightingElectricityModel extends AtomicHIOA {
    ...
    public static final String MIL_RT_URI = SmartLightingElectricityModel.class.getSimpleName() + "-MIL-RT";
    ...
    protected static boolean glassBoxInvariants(SmartLightingElectricityModel instance) {
        assert instance != null :
                new NeoSim4JavaException("SmartLightingElectricityModel: Precondition violation: instance != null");
    ...
    public SmartLightingElectricityModel(
        ...
        assert  glassBoxInvariants(this) :
                new NeoSim4JavaException("SmartLightingElectricityModel: White box invariants violation!");
        assert  blackBoxInvariants(this) :
                new NeoSim4JavaException("SmartLightingElectricityModel: Black box invariants violation!");
    }
    ...
    public void setCurrentLightingPower(double newPower, Time time) {
        assert newPower >= 0.0 &&
                ...
                new NeoSim4JavaException("SmartLightingElectricityModel: Precondition violation: newPower >= 0.0 &&" +
                                   "newPower <= MAX_LIGHTING_POWER"+
