...
public class SmartLightingStateModel extends AtomicModel implements SmartLightingOperationI {
    ...
    protected static boolean glassBoxInvariants(SmartLightingStateModel instance) {
        assert instance != null : new NeoSim4JavaException("SmartLightingStateModel: Precondition violation: " + "instance != null");

        boolean ret = true;
        ret &= InvariantChecking.checkGlassBoxInvariant(instance.currentState != null, SmartLightingStateModel.class, instance, "currentState != null");
        return ret;
    }
    ...
    protected static boolean blackBoxInvariants(SmartLightingStateModel instance) {
        ...
        boolean ret = true;
        ret &= InvariantChecking.checkBlackBoxInvariant(MIL_URI != null && !MIL_URI.isEmpty(), SmartLightingStateModel.class, instance, "MIL_URI != null && !MIL_URI.isEmpty()");
        ret &= InvariantChecking.checkBlackBoxInvariant(MIL_RT_URI != null && !MIL_RT_URI.isEmpty(), SmartLightingStateModel.class, instance, "MIL_RT_URI != null && !MIL_RT_URI.isEmpty()");
        ret &= InvariantChecking.checkBlackBoxInvariant(SIL_URI != null && !SIL_URI.isEmpty(), SmartLightingStateModel.class, instance, "SIL_URI != null && !SIL_URI.isEmpty()");
        return ret;
    }
    ...
    // Constructors
    // -------------------------------------------------------------------------
    public SmartLightingStateModel(String uri,
                                   TimeUnit simulatedTimeUnit,
                                   AtomicSimulatorI simulationEngine) throws Exception {
        super(uri, simulatedTimeUnit, simulationEngine);
        this.getSimulationEngine().setLogger(new StandardLogger());

        assert glassBoxInvariants(this) : new NeoSim4JavaException("SmartLightingStateModel: Constructor violation: " + "glassBoxInvariants(this)");
        assert blackBoxInvariants(this) : new NeoSim4JavaException("SmartLightingStateModel: Constructor violation: " + "blackBoxInvariants(this)");
    }
    ...
    public void			initialiseState(Time initialTime)
    {
        ...
        assert	glassBoxInvariants(this) :
                new NeoSim4JavaException(
                        "SmartLightingStateModel.glassBoxInvariants(this)");
        assert	blackBoxInvariants(this) :
                new NeoSim4JavaException(
                        "SmartLightingStateModel.blackBoxInvariants(this)");
    }
