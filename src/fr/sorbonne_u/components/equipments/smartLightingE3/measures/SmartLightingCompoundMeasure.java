...
public class SmartLightingCompoundMeasure extends CompoundMeasure implements SmartLightingMeasureI {
    ...
    public SmartLightingCompoundMeasure(Measure<Double> targetLightIntensity, Measure<Double> currentLightIntensity) {
        ...
        assert targetLightIntensity.getData() == this.getTargetLightIntensity() :
                new PreconditionException("targetLightIntensity.getData() == this.getTargetLightIntensity()");
        assert targetLightIntensity.getMeasurementUnit() == this.getCurrentLightIntensityMeasurementUnit() :
                new PreconditionException("targetLightIntensity.getMeasurementUnit() == this.getCurrentLightIntensityMeasurementUnit()");
        assert currentLightIntensity.getData() == this.getCurrentLightIntensity() :
                new PreconditionException("currentLightIntensity.getData() == this.getCurrentLightIntensity()");
        assert currentLightIntensity.getMeasurementUnit() == this.getCurrentLightIntensityMeasurementUnit() :
                new PreconditionException("currentLightIntensity.getMeasurementUnit() == this.getCurrentLightIntensityMeasurementUnit()");

        assert glassBoxInvariants(this) : new ImplementationInvariantException("glassBoxInvariants(HeatPumpCompoundMeasure)");
        assert blacBoxInvariants(this) : new InvariantException("blacBoxInvariants(HeatPumpCompoundMeasure)");
    }
